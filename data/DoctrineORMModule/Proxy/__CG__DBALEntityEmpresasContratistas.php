 ...
 */
class EmpresasContratistas extends \DBAL\Entity\EmpresasContratistas implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'RazonSocial', 'Direccion', 'Telefono'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (EmpresasContratistas $proxy) {

 ...
 */
class RelevamientosxSecciones extends \DBAL\Entity\RelevamientosxSecciones implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (RelevamientosxSecciones $proxy) {

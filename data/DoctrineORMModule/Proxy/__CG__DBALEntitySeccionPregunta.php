 ...
 */
class SeccionPregunta extends \DBAL\Entity\SeccionPregunta implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'id', 'seccion', 'pregunta'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (SeccionPregunta $proxy) {

 ...
 */
class Relevamientos extends \DBAL\Entity\Relevamientos implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Relevamientos $proxy) {
    ...
    public function getNodosFirmantesRelevamiento()
    {
        ...
        $this->__initializer__ && $this->__initializer__->__invoke($this, 'getNodosFirmantesRelevamiento', []);

        return parent::getNodosFirmantesRelevamiento();
    }

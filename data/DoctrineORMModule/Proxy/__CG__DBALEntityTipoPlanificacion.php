 ...
 */
class TipoPlanificacion extends \DBAL\Entity\TipoPlanificacion implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (TipoPlanificacion $proxy) {

 ...
 */
class HerramientasDeTrabajo extends \DBAL\Entity\HerramientasDeTrabajo implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (HerramientasDeTrabajo $proxy) {
